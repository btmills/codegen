...
(function() {
  (function(root, factory) {
    ...
    generate = function(tree, options) {
      var between, codegen, generators, indent, indentation, region, str, syntax, terminals;
      ...
      */
      ...
      terminals = {
        ...
        literal: function(raw) {
          return region('literal', function() {
            return str.push(raw);
          });
        },
        newline: function() {
          return str.push(options.html ? '<br />' : '\n');
        },
      ...
      generators = {
        ...
        */
        ...
        VariableDeclarator: function(id, init) {
          return region('variable-declarator', function() {
            codegen(id);
            if (init != null) {
              terminals.space();
              terminals.operator('=');
